...
def scatter_imbalance(inputs, target_gpus, dim=0):
    ...
    def scatter_map(obj):
        if isinstance(obj, torch.Tensor):
            if (len(target_gpus) == 2) and (obj.size(dim) == 80):
                return Scatter.apply(target_gpus, (32, 48), dim, obj)
            if (len(target_gpus) == 2) and (obj.size(dim) == 120):
                return Scatter.apply(target_gpus, (56, 64), dim, obj)
            if (len(target_gpus) == 3) and (obj.size(dim) == 120):
                return Scatter.apply(target_gpus, (36, 42, 42), dim, obj)
            if (len(target_gpus) == 3) and (obj.size(dim) == 180):
                return Scatter.apply(target_gpus, (52, 64, 64), dim, obj)
            if (len(target_gpus) == 4) and (obj.size(dim) == 100):
                return Scatter.apply(target_gpus, (10, 30, 30, 30), dim, obj)
            if (len(target_gpus) == 4) and (obj.size(dim) == 160):
                return Scatter.apply(target_gpus, (34, 42, 42, 42), dim, obj)
            if (len(target_gpus) == 4) and (obj.size(dim) == 240):
                return Scatter.apply(target_gpus, (48, 64, 64, 64), dim, obj)
            ...
            elif (len(target_gpus) == 4) and (obj.size(dim) == 250):
                return Scatter.apply(target_gpus, (40, 70, 70, 70), dim, obj)
            elif (len(target_gpus) == 4) and (obj.size(dim) == 500):
                return Scatter.apply(target_gpus, (110, 130, 130, 130), dim, obj)
            elif (len(target_gpus) == 4) and (obj.size(dim) == 1000):
                return Scatter.apply(target_gpus, (160, 280, 280, 280), dim, obj)
