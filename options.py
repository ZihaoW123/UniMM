...
def read_command_line(argv=None):
    ...
    parser.add_argument('-visdom_env', type=str, default='pretrain',
                            help='Name of visdom environment for plotting')
    parser.add_argument('-visdom_server', type=str, default='http://127.0.0.1',
                            help='Address of visdom server instance')
    parser.add_argument('-visdom_server_port', type=int, default=8097,
    ...
    parser.add_argument('-n_gpus',default=4, type=int, help='number of gpus running the job')
    ...
    parser.add_argument('-neg_token_weight', default=1, type=int,
                        help='neg_token_weight')
    ...
    parser.add_argument('-train_dis_rate', default=0.5, type=float, help='train_dis')
    parser.add_argument('-val_dis', default=1, type=int, help='val_dis')
    parser.add_argument('-test_dis', default=1, type=int, help='test_dis')
    ...
    try:
        ...
        assert parsed['sequences_per_image'] <= 100# 8
